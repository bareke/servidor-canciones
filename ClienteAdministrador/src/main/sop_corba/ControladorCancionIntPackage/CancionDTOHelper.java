...
abstract public class CancionDTOHelper
{
    ...
    if (__typeCode == null)
    {
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (sop_corba.ControladorCancionIntPackage.bytesHelper.id (), "bytes", _tcOf_members0);
  ...
  public static sop_corba.ControladorCancionIntPackage.CancionDTO read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.audio = sop_corba.ControladorCancionIntPackage.bytesHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, sop_corba.ControladorCancionIntPackage.CancionDTO value)
  {
    ...
    sop_corba.ControladorCancionIntPackage.bytesHelper.write (ostream, value.audio);
  }
